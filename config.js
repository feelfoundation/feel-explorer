...
config.port = 6540; // Port to listen on

/**
 * FEEL node
 */
config.feel.http = process.env.FEEL_URL_HTTP || 'http://127.0.0.1:4500/api';
config.feel.ws = process.env.FEEL_URL_WS || 'ws://127.0.0.1:4500';
...
// F39/BTC pair, supported: poloniex
config.exchangeRates.exchanges.F39.BTC = 'poloniex';
 ...
 */
config.knownAccountsUrl = 'https://static-data.feel.surf';
