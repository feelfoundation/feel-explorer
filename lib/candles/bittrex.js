...
function BittrexCandles(...rest) {
	...
	this.url = 'https://bittrex.com/Api/v2.0/pub/market/GetTicks?marketName=BTC-F39&tickInterval=fiveMin';
	this.start = '';
	this.last = null;
	...
	this.parser = function (period) {
		...
		return {
			...
			feelVolume: _.reduce(period, (memo, t) =>
				(memo + parseFloat(t[this.candle.feelVolume])), 0.0).toFixed(8),
