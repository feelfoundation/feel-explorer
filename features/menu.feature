Feature: Top menu
  ...
  Scenario: should allow to find an account by address
    Given I'm on page "/"
    And I fill in "16313739661670634666F" to "search" field in "desktop search" div
    And I hit "enter" in "search" field in "desktop search" div
  ...
  Scenario: should allow to find a delegate by username
    ...
    And I hit "enter" in "search" field in "desktop search" div
    And I wait 1 seconds
    Then I should be on page "/address/537318935439898807F"
  ...
  Scenario: should allow to show a delegate list
    ...
    Then I should be on page "/address/12254605294831056546F"
