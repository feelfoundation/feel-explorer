Feature: Blocks page
  Scenario: should show title, summary, and transactions
    ...
    And I should see table "table blocks" with 20 rows starting with:
      ...
      |----------------|--------|---------------------------|----------------|-------------------|-------------|----------|
      | /\d{18,20}/    | 24254  | /2017\/06\/19 \d\d:33:00/ | 0              | /genesis_\d{1,3}/ | 0 F39       | 5.0 F39  | 
      | /\d{18,20}/    | 24253  | /2017\/06\/19 \d\d:32:50/ | 0              | /genesis_\d{1,3}/ | 0 F39       | 5.0 F39  | 
      | /\d{18,20}/    | 24252  | /2017\/06\/19 \d\d:32:40/ | 0              | /genesis_\d{1,3}/ | 0 F39       | 5.0 F39  | 
      | /\d{18,20}/    | 24251  | /2017\/06\/19 \d\d:32:30/ | 0              | /genesis_\d{1,3}/ | 0 F39       | 5.0 F39  | 
      | /\d{18,20}/    | 24250  | /2017\/06\/19 \d\d:18:20/ | 1              | /genesis_\d{1,3}/ | 123.45 F39  | 5.1 F39  | 
