Feature: Transaction page
  ...
  Scenario: should show title, summary, and details
    ...
    And I should see table "summary" containing:
      ...
      | Sender              | 1085993630748340485F      |
      | Recipient           | 16313739661670634666F     |
      | Confirmations       | /\d+/                     |
      | Amount              | 100,000,000 F39           |
      | Fee                 | 0 F39                     |
  ...
  Scenario: should link added votes to address page
    ...
    Then I should be on page "/address/11194005483892021001F"
  ...
  Scenario: should link deleted votes to address page
    ...
    Then I should be on page "/address/2581762640681118072F"
