...
AppFilters.filter('currency', (numberFilter, feelFilter, fiatFilter, isFiat) => (amount, currency, decimalPlacesCrypto, decimalPlacesFiat) => {
	...
	if (currency.tickers && currency.tickers.F39 && currency.tickers.F39[currency.symbol]) {
		factor = currency.tickers.F39[currency.symbol];
	} else if (currency.symbol !== 'F39') {
