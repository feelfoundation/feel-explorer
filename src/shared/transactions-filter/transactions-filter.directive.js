...
const TransactionsConstructor = function ($rootScope, $scope, $stateParams, $element, $state) {
	...
	$scope.availableSearchParams = [
		{ key: 'address', name: 'Address', placeholder: 'Address...', example: '12317412804123F', visible: ['transactions'] },
		{ key: 'senderId', name: 'Sender ID', placeholder: 'Sender...', example: '12317412804123F', visible: ['transactions', 'address'] },
		...
		{ key: 'recipientId', name: 'Recipient ID', placeholder: 'Recipient...', example: '12317412804123F', visible: ['transactions', 'address'] },
		...
		// { key: 'limit', name: 'Limit', placeholder: 'Limit...', example: '12317412804123F' },
		// { key: 'offset', name: 'Offset', placeholder: 'Offset...', example: '12317412804123F' },
		// {
		// 	key: 'sort',
		// 	name: 'Order By',
