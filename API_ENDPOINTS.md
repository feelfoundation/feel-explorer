...
`/api/getAccount?address=16313739661670634666F`
...
```
{
  ...
  "block": {
    ...
    "confirmations": 17313,
    "generatorId": "1085993630748340485F",
...
```
{
  ...
  "results": [
    {
      "address": "6147291942291731858F",
      "username": "genesis_10",
      "similarity": 1
    },
    {
      "address": "10881167371402274308F",
      "username": "genesis_100",
      "similarity": 0.9473684210526315
    },
    {
      "address": "6726252519465624456F",
...
```
{
  ...
  "block": {
    ...
    "confirmations": 1,
    "generatorId": "6996737717246838071F",
...
```
{
  "block": {
    ...
    "confirmations": 1,
    "generatorId": "5370200325671668788F",
...
```
{
  "best": {
    ...
    "confirmations": 1,
    "generatorId": "2193676322954236363F",
...
`/api/getTransactionsByAddress?address=16313739661670634666F&limit=50&offset=0`
  ...
  "transactions": [
    {
      ...
      "recipientId": "12187704147173966838F",
